      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16 lg:pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-[#EFE9DA]/90 leading-relaxed">
              Home physiotherapy around Hegganahalli Cross, Bengaluru. Direct home visits provided by {SITE_CONFIG.practitionerName} ({SITE_CONFIG.yearsOfExperience}).
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link href="/areas-we-serve" className="hover:text-white transition-colors text-[#EFE9DA]/90">
                  Areas We Serve
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-3">
            <h3 className="text-base font-bold text-white mb-4 tracking-wide">Important Disclosure</h3>
            <div className="bg-[#1E332C] p-4 rounded-2xl border border-[#2F5245] space-y-2.5">
              ...
              <p className="text-xs text-[#EFE9DA]/90 leading-relaxed">
                Home visits only. No physical clinic. Service availability depends on location and appointment availability.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-[#2F5245] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#EFE9DA]/70">
          ...
          <p className="text-center sm:text-right">
            Home Visit Physiotherapy • Around Hegganahalli Cross, Bengaluru
          </p>
        </div>
      </div>
    </footer>
